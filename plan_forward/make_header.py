...
SAVE_HEADER_PATH_1 = os.path.join(os.path.dirname(__file__), "..", "include", "natsu24", 'PathF.h')
SAVE_HEADER_PATH_2 = os.path.join(os.path.dirname(__file__), "..", "gr-sakura", "natsu24", 'PathF.h')
